          ...
          <form onSubmit={handleChangePassword}>
            ...
            <div className="form-group">
              ...
              <input
                ...
                placeholder={`Entrez votre ${token ? 'nouveau' : 'actuel'} mot de passe`}
            ...
            <div className="form-group">
              ...
              <label htmlFor="confirmPassword">
                ...
                {token ? 'Confirmez le nouveau mot de passe' : 'Nouveau mot de passe'}
              ...
              <input
                ...
                placeholder={`Entrez ${token ? 'à nouveau' : 'votre nouveau'} mot de passe`}
